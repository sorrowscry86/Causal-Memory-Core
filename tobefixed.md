...
| CPI-006 | The test suite has 0% coverage for `src/api_server.py`. | High | Completed | Jules | The API server logic is completely untested, which could hide significant bugs. Add comprehensive tests for all API endpoints. |
